          ...
          <button
            ...
            style={{
              ...
              background: selectedCatId === 'random'
                ? (isLockedMode ? 'linear-gradient(135deg, #C2185B, #E91E90)' : 'linear-gradient(135deg, rgba(255,107,26,0.95) 0%, rgba(255,51,133,0.95) 30%, rgba(155,89,182,0.95) 60%, rgba(52,152,219,0.95) 80%, rgba(46,204,113,0.95) 100%)')
                : (isLockedMode ? 'linear-gradient(135deg, #C2185Bcc, #E91E90cc)' : 'linear-gradient(135deg, rgba(255,107,26,0.65) 0%, rgba(255,51,133,0.65) 30%, rgba(155,89,182,0.65) 60%, rgba(52,152,219,0.65) 80%, rgba(46,204,113,0.65) 100%)'),
              borderRadius: S(14),
              padding: `${S(10)} ${S(12)}`,
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: S(6), minWidth: 0, width: '100%' }}>
                  ...
                  {isComplete ? (
                    <span style={{
                      fontSize: S(9), fontWeight: 900, color: '#E91E90',
                      flexShrink: 0,
        ...
        <button
          ...
          style={{
            ...
            background: hasSelection
              ? (isLockedMode ? '#C2185B' : `linear-gradient(135deg, ${getCategoryColor(selectedCat) || '#FF6B1A'}, ${getCategoryColor(selectedCat) || '#FF6B1A'}cc)`)
