...
const CHAPTERS = [
  ...
  // ═══ MODES DE JEU ═══
  {
    ...
    title: 'Quest',
    content: [
      { icon: '🔋', text: '**Coût :** 1 énergie par bloc de 10 questions.' },
      { icon: '📋', text: '**Bloc :** 10 Funny + 1 boss VIP conditionnel.' },
      { icon: '🔢', text: '**QCM :** 4/question.' },
      { icon: '⏱️', text: '**Timer :** 20s/question.' },
      { icon: '💡', text: '**Indices :** 2/question (stock perso).' },
      { icon: '👑', text: '**Boss VIP** débloqué à **5/10** bonnes réponses ou plus.' },
      { icon: '🪙', text: '**Gains :** 20 WTFCoins/bonne · +100 WTFCoins/boss vaincu.' },
      { icon: '🔒', text: 'Boss raté → bloc à refaire pour débloquer le f*ct VIP.' },
    ],
  },
  {
    id: 'snack',
