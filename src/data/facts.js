export const CATEGORIES = [
  ...
  { id: 'animaux-terrestres',label: 'Animaux Terrestres',       emoji: '🦁', color: '#6BCB77', bg: '#0A2A0E' },
  ...
  { id: 'dictons',           label: 'Dictons & Expressions',    emoji: '🗨️', color: '#E67E22', bg: '#2A1500' },
  ...
  { id: 'inventions',        label: 'Inventions & Découvertes', emoji: '💡', color: '#F1C40F', bg: '#2A2000' },
