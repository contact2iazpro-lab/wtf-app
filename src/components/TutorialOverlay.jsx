...
const STEPS = [
  ...
  },
  {
    ...
    subtitle: null,
    bullets: [
      { icon: '🔓', text: 'Chaque **bonne réponse** débloque un f*ct dans ta collection.' },
      { icon: '🗂️', text: 'F*cts rangés par **catégorie** : animaux, sciences, sport...' },
      { icon: '⚠️', text: 'Tu dois **terminer la session** pour sauvegarder tes f*cts !' },
    ],
    visual: {
      type: 'collection',
      categories: [
  ...
  },
  {
    ...
    subtitle: null,
    bullets: [
      { icon: '🌟', text: 'Complète **tous les f*cts** d\'une catégorie pour un niveau...' },
  ...
  },
  {
    ...
    bullets: [
      ...
      { icon: '🪙', text: 'Plus ta série est haute → plus de **WTF! Coins** gagnés !' },
