export const CATEGORIES = [
  ...
  { id: 'definition',        label: 'Définition',          emoji: '📖', color: '#4A9BD9', bg: '#0A1A35', image: 'Carte WTF Definition.png' },
  { id: 'dictons',           label: 'Dictons & Expressions',    emoji: '🗨️', color: '#4CAF50', bg: '#0A2A0E' },
  ...
  { id: 'histoire',          label: 'Histoire',                 emoji: '📜', color: '#E8A030', bg: '#3A2000', image: 'Carte WTF Histoire.png' },
  { id: 'internet',          label: 'Internet & Réseaux',       emoji: '📡', color: '#5B8DBE', bg: '#0A1A35', image: 'Carte WTF Internet.png' },
  { id: 'inventions',        label: 'Inventions & Découvertes', emoji: '💡', color: '#5BC0DE', bg: '#0A2035' },
