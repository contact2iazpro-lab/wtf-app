...
const DIFFICULTY_LEVELS = {
  EXPERT: { id: 'expert', label: 'Quête WTF! Addict', emoji: '⚡', choices: 6, duration: 30, hintsAllowed: true, freeHints: 0, paidHints: 1, hintCost: 8, coinsPerCorrect: 5, scoring: { correct: 5, wrong: 0 } },
  NORMAL: { id: 'normal', label: 'Quête À fond',      emoji: '🧠', choices: 4, duration: 30, hintsAllowed: true, freeHints: 0, paidHints: 2, hintCost: 5, coinsPerCorrect: 3, scoring: { correct: 3, wrong: 0 } },
  EASY:   { id: 'easy',   label: 'Quête Curieux',     emoji: '💚', choices: 4, duration: 30, hintsAllowed: true, freeHints: 1, paidHints: 1, hintCost: 3, coinsPerCorrect: 3, scoring: { correct: 3, wrong: 0 } },
  FLASH:  { id: 'flash',  label: 'Session Flash',     emoji: '⚡', choices: 4, duration: 60, hintsAllowed: true, freeHints: 1, paidHints: 1, hintCost: 3, scoring: { correct: [5, 3, 2], wrong: 0 } },
}
