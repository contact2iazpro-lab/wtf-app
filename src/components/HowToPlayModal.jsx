...
const CHAPTERS = [
  ...
  // ═══ MODES DE JEU (ordre CLAUDE.md) ═══
  {
    ...
    content: [
      ...
      { icon: '🎁', text: 'Perfect (5/5) : +50 WTFCoins' },
    ],
  },
  {
    id: 'vrai_ou_fou',
  ...
  },
  {
    ...
    content: [
      ...
      { icon: '🪙', text: 'Gains : 20 WTFCoins/bonne · +100 WTFCoins/boss vaincu' },
  ...
  },
  {
    ...
    title: 'Mode Blitz',
    content: [
      { icon: '🆓', text: 'Coût : gratuit (Solo) · 200 WTFCoins pour créer un Défi' },
  ...
  },
  {
    ...
    content: [
      ...
      { icon: '📅', text: 'Lun-Sam : Funny thème du jour — 0 indice — **30 WTFCoins fixe**' },
  ...
  // ═══ SÉRIE (STREAK) ═══
  {
    ...
    content: [
      ...
      { icon: '🥉', text: '**Débutant (J3)** : 75 WTFCoins' },
      { icon: '🥈', text: '**Habitué (J7)** : 200 WTFCoins + 2 indices' },
      { icon: '🥇', text: '**Fidèle (J14)** : 500 WTFCoins' },
      { icon: '👑', text: '**Légende (J30)** : 1 000 WTFCoins + cadre exclusif' },
      { icon: '🛡️', text: 'Achète un **Streak Freeze** (150 WTFCoins) pour protéger ta série.' },
    ],
  },
  ...
  // ═══ ROULETTE ═══
  {
    ...
    content: [
      ...
      { icon: '🪙', text: 'Tours supplémentaires : **100 WTFCoins**.' },
      { icon: '🎯', text: 'La roue contient : **20 · 50 · 100 · 150 · 300 · 750 WTFCoins** ou **1-2 indices**.' },
      { icon: '💎', text: 'Jackpot **750 WTFCoins** : ultra-rare — tente ta chance !' },
  ...
  // ═══ BOUTIQUE ═══
  {
    ...
    title: 'La Boutique',
    content: [
      { icon: '💡', text: '**Indices** : 1 (50 WTFCoins) · 3 (140, -7%) · 5 (220, -12%)' },
      { icon: '🔋', text: '**Énergie** : 1 (75 WTFCoins) · 3 (200, -11%) · 5 (320, -15%)' },
      { icon: '🛡️', text: '**Streak Freeze** : 150 WTFCoins — protège ta série pendant 1 jour' },
      { icon: '✨', text: '**Cadres de profil** : 300 à 800 WTFCoins' },
  ...
  // ═══ ASTUCES ═══
  {
    ...
    content: [
      ...
      { icon: '⚔️', text: 'Envoie un **Défi Blitz** à un ami (200 WTFCoins) pour la gloire !' },
