...
const CHAPTERS = [
  ...
  },
  {
    ...
    title: 'Quête WTF!',
    content: [
      { icon: '🎯', text: 'Le mode principal. Choisis une **catégorie** et un **niveau de difficulté**.' },
      { icon: '❄️', text: '**Cool** — 4 choix de réponse · 2 indices · 3 coins par bonne réponse' },
      { icon: '🔥', text: '**Hot** — 4 choix de réponse · 2 indices · 3 coins par bonne réponse' },
      { icon: '⚡', text: '**WTF!** — 6 choix de réponse · 1 indice · 5 coins par bonne réponse' },
  ...
  },
  {
    ...
    title: 'Marathon',
    content: [
      { icon: '🏃', text: '**20 questions** enchaînées dans la catégorie de ton choix.' },
      { icon: '🪙', text: '**3 coins** par bonne réponse, difficulté Hot.' },
      { icon: '🎯', text: 'Score parfait (20/20) = **bonus de 20 coins** !' },
      { icon: '🚪', text: 'Tu peux quitter à tout moment — tes coins gagnés sont conservés.' },
    ],
  },
  {
    id: 'flash',
  ...
  },
  {
    ...
    title: 'Indices & Coins',
    content: [
      { icon: '💡', text: 'Les indices **éliminent une mauvaise réponse** et coûtent des coins.' },
      { icon: '❄️', text: '**Cool / Hot** : 2 indices disponibles à **5 coins** chacun.' },
      { icon: '⚡', text: '**WTF!** : 1 seul indice à **8 coins**.' },
      { icon: '🪙', text: 'Gagne des coins en jouant, en ouvrant les **coffres quotidiens**, et en maintenant ta série.' },
    ],
  },
  {
    id: 'collection',
    ...
    content: [
      ...
      { icon: '💡', text: 'Un f*ct déjà débloqué **ne réapparaît plus** en Quête.' },
